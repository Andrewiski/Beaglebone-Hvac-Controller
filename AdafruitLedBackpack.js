...
var adafruitLedBackpack = function () {
    ...
    self.Initialize = function (options, Callback) {
        ...
        //bonescript.i2c.open(objOptions.I2CDevice, objOptions.I2CAddress,
        //    function () {
        ...
        //        } else {
        //            //i2cdevice = port;
        //            debug('bonescript i2c.open success ', i2cdevice);
        ...
        //                function (err) {
        //                    if (err) {
        //                        debug('Error in init DisplayOn %s', err);
        //                        if (Callback) {
        //                            Callback(err);
        //                        }
        //                    } else {
        //                        debug('ocillator enabled ' + objOptions.I2CAddress + " device " + objOptions.I2CDevice);
        //                        i2cdevice.setAddress(objOptions.I2CAddress);
        //                        i2cdevice.writeBytes(HT16K33_BLINK_CMD | 0x01, [0x00], function (err) {
        //                            if (err) {
        //                                debug('Error in init setBlinkRate %s', err);
        //                                if (Callback) {
        //                                    Callback(err);
        //                                }
        //                            } else {
        //                                debug('display enabled ' + objOptions.I2CAddress + " device " + objOptions.I2CDevice);
        //                                i2cdevice.setAddress(objOptions.I2CAddress);
        //                                i2cdevice.writeBytes(HT16K33_CMD_BRIGHTNESS |  15, [0x00], function (err) {
        //                                    if (err) {
        //                                        debug('Error in init setBrightness %s', err);
        //                                    } else {
        //                                        debug('Brightness set to high ' + objOptions.I2CAddress + " device " + objOptions.I2CDevice);
        //                                        i2cdevice.setAddress(objOptions.I2CAddress);
        //                                        i2cdevice.writeBytes([0x00], [digits[2], 0x00, digits[2], 0x00, 0x02, 0x00, digits[3], 0x00, digits[4], 0x00], function (err) {
        //                                            if (err) {
        //                                                debug('Error in write zeros', err);
        //                                            } else {
        //                                                debug('wrote zeros ', i2cdevice.address);
        //                                            }
        //                                        });
        //                                        isInited = true;
        //                                        if (Callback) {
