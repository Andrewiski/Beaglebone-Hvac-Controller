...
.directive('datetimepickerPopup', ['$compile', '$parse', '$document', '$position', 'dateFilter', 'datetimeParser', 'dateParser', 'datetimepickerPopupConfig', '$timeout',
function ($compile, $parse, $document, $position, dateFilter, datetimeParser, dateParser, datetimepickerPopupConfig, $timeout) {
    return {
        restrict: 'EA',
        require: 'ngModel',
        scope: {
...
.directive('timepickerPopup', ['$compile', '$parse', '$document', '$position', 'dateFilter', 'dateParser', 'timepickerPopupConfig', '$timeout',
function ($compile, $parse, $document, $position, dateFilter, dateParser, timepickerPopupConfig, $timeout) {
    return {
        restrict: 'EA',
        require: 'ngModel',
        scope: {
